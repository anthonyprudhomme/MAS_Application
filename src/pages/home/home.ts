        ...
        tx.executeSql('SELECT * FROM events;', [], function (tx, rs) {
          ...
          for (var i = 0; i < rs.rows.length; i++) {
            ...
            events.push({
              ...
              "duration_minute": element.duration_minute,
              "lang": element.lang,
              "end": element.end,
              "price": element.price,
